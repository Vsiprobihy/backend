...
class DistanceDetailView(APIView):
    ...
    @swagger_auto_schema(**SwaggerDocs.Distances.post)
    ...
    @swagger_auto_schema(**SwaggerDocs.Distances.get)
    @check_organization_access_decorator(extract_event_directly)
    ...
    @swagger_auto_schema(**SwaggerDocs.Distances.put)
    @check_organization_access_decorator(extract_event_directly)
    ...
    @swagger_auto_schema(**SwaggerDocs.Distances.patch)
    @check_organization_access_decorator(extract_event_directly)
    ...
    @swagger_auto_schema(**SwaggerDocs.Distances.delete)
    @check_organization_access_decorator(extract_event_directly)
